					...
					<div class="min-h-screen bg-gray-50 p-2 sm:p-4 md:p-6">
						...
						<div class="max-w-7xl mx-auto px-2 sm:px-4">
							<div class="text-center mb-4 sm:mb-6 md:mb-8">
								<h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-2" style="font-family: 'Cairo', sans-serif;">Create Service Order</h1>
								<p class="text-sm sm:text-base text-gray-500">Fill in the details below to create a new order</p>
							</div>
